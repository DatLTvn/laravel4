...
{   
    ...
    public function all_category_product(){
            $all_category_product = DB::table("tbl_all_category_product")->paginate(3);
    ...
    public function save_category_product(Request $request){ 
        ...
        'category_product_gia' =>  'required|integer', //check mail co ton tai chua
        'category_product_desc' => 'required',
        'category_file' => 'mimes:png,jpg,jpeg|max:1024'
        ];
        $messages = [
        'category_product_name.required' =>'Tên không được bỏ trống, vui lòng nhập tên sản phẩm',
        'category_product_name.min'=> 'Tên phải lớn hơn 5 kí tự',
        'category_product_gia.required' =>'Giá không được bỏ trống',   
        'category_product_gia.integer' =>'Giá là số lớn hơn 0',
        'category_product_desc.required' =>'Tình trạng không được bỏ trống',
        'category_file.mimes' => 'Khong dung dinh dang',
        'category_file.max' => 'Khong qua 1024byte'
            ];
        ...
        if ($validator=!null){
            $data = array();
            $data['category_name'] =$request->category_product_name; //du lieu ben phpadmin //$request ten cua name ben add
    ...
    public function delete_category_product($category_id){ ////xoa san pham
